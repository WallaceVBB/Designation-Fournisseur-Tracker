...
class PomonaTerreAzurScraper(BaseScraper):

    sections = ("poissons", "coquillages", "crustaces","cephalopodes",
                "traiteur-mer", "fruits-frais", "legumes-frais",
                "fruits-prets-emploi", "legumes-prets-emploi")

    def run(self):
        print("🚚 Scraping Pomona TerreAzur...")
