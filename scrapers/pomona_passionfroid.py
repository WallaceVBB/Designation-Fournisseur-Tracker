...
class PomonaPassionFroidScraper(BaseScraper):

    sections = ("cocktail", "charcuterie", "entree","crustace-et-mollusque",
                "poisson", "viande", "volaille", "plat-cuisine",
                "garniture", "base-pate", "produit-laitier","dessert", "glace")

    def run(self):
        print("🚚 Scraping Pomona PassionFroid...")
        
        for section in self.sections:
            print (f"\n🔍 Section: {section}")
            BASE_URL = f"https://www.terreazur.fr/produits/{section}"
    ...
    def extract_product(self, product):
        data = {
            ...
            "reference": None,
            "url_product": None,
            "Fournisseur": "Pomona PassionFroid"
        }
